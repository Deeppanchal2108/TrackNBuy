...
export default function Home() {
  const [url, setUrl] = useState(""); // Ensure state is always initialized to a string
      ...
      <div className="text-center relative z-20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 max-w-md mx-auto">
          ...
          <Button
            ...
            className="px-6 py-2 rounded-md text-white bg-gradient-to-r from-gray-100 to-gray-500 hover:from-blue-500 hover:to-green-400 transition-all"
          >
            Track
          </Button>
        </div>
